...
class Ui_PyreeMainWindow(object):
    def setupUi(self, PyreeMainWindow):
        ...
        self.workersDockWidget.setFeatures(QtWidgets.QDockWidget.DockWidgetFloatable|QtWidgets.QDockWidget.DockWidgetMovable)
        ...
        self.sheetsDockWidget.setFeatures(QtWidgets.QDockWidget.DockWidgetFloatable|QtWidgets.QDockWidget.DockWidgetMovable)
        ...
        self.propertiesDockWidget.setMinimumSize(QtCore.QSize(200, 400))
        self.propertiesDockWidget.setFeatures(QtWidgets.QDockWidget.DockWidgetFloatable|QtWidgets.QDockWidget.DockWidgetMovable)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 180, 552))
